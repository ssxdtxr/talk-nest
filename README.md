...
NODE_ENV='development' //Окружение разработки <'development' | 'prodaction'>

APPLICATION_PORT //Порт, на котором запускается приложение
APPLICATION_URL // URL backend
ALLOWED_ORIGIN// URL frontend (для корсов)
...
SESSION_MAX_AGE
SESSION_HTTP_ONLY
SESSION_SECURE // Должна ли кука передаваться только по защищенному соединению
SESSION_FOLDER
